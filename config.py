...
UPSTREAM_REPO = getenv(
    "UPSTREAM_REPO",
    "https://github.com/vinitgodaragodara9-spec/RADHEBIT",
)
...
SUPPORT_CHANNEL = getenv("SUPPORT_CHANNEL", "https://t.me/POETRYORBIT")
SUPPORT_CHAT = getenv("SUPPORT_CHAT", "https://t.me/POETRYORBIT")
